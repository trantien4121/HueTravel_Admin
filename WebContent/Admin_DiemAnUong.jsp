...
<title>Admin - Diem An Uong</title>
</head>
<style>
.nav-link {
	color: #5AA469;
					...
					<ul
						...
						<li><a href="#submenu3" data-bs-toggle="collapse"
							...
							<ul class="collapse nav flex-column ms-1" id="submenu3"
								data-bs-parent="#menu">
								<li class="w-100"><a href="htadmin_Travel_DiemAnUong"
					...
					<div class="col-lg">
						<nav class="navbar bg-dark p-3">
							<div class="container-fluid">
								...
								<!-- Modal -->
								<form action="CRUDDiemAnUong" method="post" enctype= "multipart/form-data">
										...
										<div
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="form-group">
														<label for="Name" class="col-form-label">Tên điểm
															ăn uống:</label> <input type="text" class="form-control"
															id="ten" name="txtName">
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														<label for="DienThoai" class="col-form-label">Điện
															...
															id="dienthoai" name="txtDienThoai">
													</div>
													<div class="form-group">
														<label for="thoigian" class="col-form-label">Thời
														gian hoạt động:</label> <input
															type="text" class="form-control" id="thoigian" name="txtThoiGian">
													</div>
													<div class="form-group">
												...
												<div class="modal-footer">
													...
													<button type="submit" name="butthemdau"
					...
					<div class="col">
						<table class="table table-dark table-bordered">
							...
							<tbody style="font-weight: 600">
								<c:forEach var="u" items="${dsDau}">
									<tr>
										<td class="pl-1 pt-4">${u.getDiemAnUongId()}</td>
										<td class="pl-1 pt-4">${u.getDiemAnUongName()}</td>
											...
											<table class="table table-dark table-borderless">
												...
												<td class="pt-4">
													...
													<button type="submit" class="btn btn-info"
														...
														data-bs-target="#modalxem${u.getDiemAnUongId()}">
														<i class="bi bi-eye"></i>
													</button>
													<div class="modal fade"
														id="modalxem${u.getDiemAnUongId()}" tabindex="-1"
														aria-labelledby="exampleModalLabel" aria-hidden="true">
														<div
															class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
															<div class="modal-content">
																<div class="modal-header">
																	<h1 class="modal-title fs-5" id="exampleModalLabel"
																		style="color: black">Chi tiết điểm ăn uống</h1>
																	<button type="button" class="btn-close"
																		data-bs-dismiss="modal" aria-label="Close"></button>
																</div>
																<div class="modal-body">
																	<div class="form-group">
																		<label for="Name" class="col-form-label"
																			style="color: black">Tên điểm ăn uống:</label> <input
																			type="text" class="form-control"
																			value="${u.getDiemAnUongName() }">
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		<label for="ThoiGian" class="col-form-label"
																			style="color: black">Thời gian hoạt động:</label> <input type="text"
																			class="form-control" value="${u.getThoiGianHoatDong() }">
																	</div>
																	<div class="form-group">
												...
												<td class="pt-4">
													<!-- <form action="CRUDDiemAnUong" method="post">
													...
													<button type="submit" class="btn btn-success"
														data-bs-toggle="modal"
														data-bs-target="#modalsua${u.getDiemAnUongId()}">
														<i class="bi bi-pencil-square"></i>
													</button>
													<form action="CRUDDiemAnUong" method="post">
														<div class="modal fade"
															id="modalsua${u.getDiemAnUongId()}" tabindex="-1"
															aria-labelledby="exampleModalLabel" aria-hidden="true">
															<div
																class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
																<div class="modal-content">
																	<div class="modal-header">
																		<h1 class="modal-title fs-5" id="exampleModalLabel"
																			style="color: black">Chỉnh sửa điểm ăn uống</h1>
																		<button type="button" class="btn-close"
																			data-bs-dismiss="modal" aria-label="Close"></button>
																	</div>
																	<div class="modal-body">
																		<div class="form-group">
																			<label for="Name" class="col-form-label"
																				style="color: black">Tên điểm ăn uống:</label> <input
																				type="text" class="form-control"
																				value="${u.getDiemAnUongName()}" id="Name" name="txtTenS">
																		</div>
																		<div class="form-group">
																			<label for="DiaChi" class="col-form-label"
																				style="color: black">Địa Chỉ:</label> <input
																		...
																		<div class="form-group">
																			<label for="DienThoai" class="col-form-label"
																				style="color: black">Điện thoại:</label> <input
																				type="text" class="form-control"
																				value="${u.getDienThoai()}" id="DienThoai" name="txtDienThoaiS">
																		</div>
																		<div class="form-group">
																			<label for="ThoiGian" class="col-form-label"
																				style="color: black">Thời gian hoạt động:</label> <input type="text"
																				class="form-control" value="${u.getThoiGianHoatDong() }" id="ThoiGian" name="txtThoiGianS">
																		</div>
																		<div class="form-group">
																			<label for="HinhAnh" class="col-form-label"
																				style="color: black">Ảnh:</label> <img
																		...
																		<div class="form-group">
																			<label for="Tag" class="col-form-label"
																				style="color: black">Tag:</label> <input type="text"
																				class="form-control"
																				value="${u.getDiemAnUongTag()}" id="Tag" name="txtTagS">
																		</div>
																	</div>
																	<div class="modal-footer">
																		<button type="button" class="btn btn-secondary"
																			data-bs-dismiss="modal">Close</button>
																		<button type="submit" name="butsuadau" value="${u.getDiemAnUongId()}"
												...
												<td class="pt-4">
													<form action="CRUDDiemAnUong" method="post">
														<button type="submit" class="btn btn-danger"
															name="butxoadau" value="${u.getDiemAnUongId() }">

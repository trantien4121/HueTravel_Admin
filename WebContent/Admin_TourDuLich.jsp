...
<title>Admin - Tour Du Lich</title>
</head>
<style>
.nav-link {
	color: #5AA469;
					...
					<ul
						...
						<li><a href="#submenu3" data-bs-toggle="collapse"
							...
							<ul class="collapse nav flex-column ms-1" id="submenu3"
								...
								<li><a href="htadmin_Travel_Tour" class="nav-link px-3"> <i
					...
					<div class="col-lg">
						<nav class="navbar bg-dark p-3">
							<div class="container-fluid">
								...
								<!-- Modal -->
								<form action="CRUDTour" method="post" enctype= "multipart/form-data">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="form-group">
														<label for="Name" class="col-form-label">Tên tour
															du lịch:</label> <input type="text" class="form-control"
															id="ten" name="txtName">
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														<label for="TinhTrang" class="col-form-label">Điện
															thoại:</label> <input type="text" class="form-control"
															id="dienthoai" name="txtDienThoai">
													</div>
													<div class="form-group">
														<label for="tenloai" class="col-form-label">Email:</label> <input
															type="text" class="form-control" id="email" name="txtEmail">
													</div>
													<div class="form-group">
												...
												<div class="modal-footer">
													...
													<button type="submit" name="butthemtdl"
					...
					<div class="col">
						<table class="table table-dark table-bordered">
							...
							<tbody style="font-weight: 600">
								<c:forEach var="u" items="${dsTour}">
									<tr>
										<td class="pl-1 pt-4">${u.getTourId()}</td>
										<td class="pl-1 pt-4">${u.getTourName()}</td>
											...
											<table class="table table-dark table-borderless">
												...
												<td class="pt-4">
													...
													<button type="submit" class="btn btn-info"
														...
														data-bs-target="#modalxem${u.getTourId()}">
														<i class="bi bi-eye"></i>
													</button>
													<div class="modal fade"
														id="modalxem${u.getTourId()}" tabindex="-1"
														aria-labelledby="exampleModalLabel" aria-hidden="true">
														<div
															class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
															<div class="modal-content">
																<div class="modal-header">
																	<h1 class="modal-title fs-5" id="exampleModalLabel"
																		style="color: black">Chi tiết Tour du lịch</h1>
																	<button type="button" class="btn-close"
																		data-bs-dismiss="modal" aria-label="Close"></button>
																</div>
																<div class="modal-body">
																	<div class="form-group">
																		<label for="Name" class="col-form-label"
																			style="color: black">Tên tour du lịch:</label> <input
																	...
																	<div class="form-group">
																		<label for="Email" class="col-form-label"
																			style="color: black">Email:</label> <input type="text"
												...
												<td class="pt-4">
													<!-- <form action="CRUDTour" method="post">
													...
													<button type="submit" class="btn btn-success"
														data-bs-toggle="modal"
														data-bs-target="#modalsua${u.getTourId()}">
														<i class="bi bi-pencil-square"></i>
													</button>
													<form action="CRUDTour" method="post">
														<div class="modal fade"
															id="modalsua${u.getTourId()}" tabindex="-1"
															aria-labelledby="exampleModalLabel" aria-hidden="true">
															<div
																class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
																<div class="modal-content">
																	<div class="modal-header">
																		<h1 class="modal-title fs-5" id="exampleModalLabel"
																			style="color: black">Chỉnh sửa Tour du lịch</h1>
																		<button type="button" class="btn-close"
																			data-bs-dismiss="modal" aria-label="Close"></button>
																	</div>
																	<div class="modal-body">
																		<div class="form-group">
																			<label for="Name" class="col-form-label"
																				style="color: black">Tên tour du lịch:</label> <input
																				type="text" class="form-control"
																				value="${u.getTourName()}" id="Name" name="txtTenS">
																		</div>
																		<div class="form-group">
																			<label for="DiaChi" class="col-form-label"
																				style="color: black">Địa Chỉ:</label> <input
																		...
																		<div class="form-group">
																			<label for="Email" class="col-form-label"
																				style="color: black">Email:</label> <input type="text"
																				class="form-control" value="${u.getEmail() }" id="Email" name="txtEmailS">
																		</div>
																		<div class="form-group">
																			<label for="HinhAnh" class="col-form-label"
																				style="color: black">Ảnh:</label> <img
																		...
																		<div class="form-group">
																			<label for="Tag" class="col-form-label"
																				style="color: black">Tag:</label> <input type="text"
																				class="form-control"
																				value="${u.getTourTag()}" id="Tag" name="txtTagS">
																		</div>
																	</div>
																	<div class="modal-footer">
																		<button type="button" class="btn btn-secondary"
																			data-bs-dismiss="modal">Close</button>
																		<button type="submit" name="butsuatdl" value="${u.getTourId()}"
												...
												<td class="pt-4">
													<form action="CRUDTour" method="post">
														<button type="submit" class="btn btn-danger"
															name="butxoatdl" value="${u.getTourId() }">

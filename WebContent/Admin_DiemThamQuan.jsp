...
<title>Admin - Diem Tham Quan</title>
</head>
<style>
.nav-link {
	color: #5AA469;
					...
					<div class="col-lg">
						<nav class="navbar bg-dark p-3">
							<div class="container-fluid">
								...
								<!-- Modal -->
								<form action="CRUDdiemthamquan" method="post" enctype= "multipart/form-data">
										...
										<div
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="form-group">
														<label for="Name" class="col-form-label">Tên điểm
															tham quan:</label> <input type="text" class="form-control"
															id="ten" name="txtName">
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														<label for="TinhTrang" class="col-form-label">Tình
															Trạng:</label> <input type="text" class="form-control"
															id="tinhtrang" name="txtTinhTrang">
													</div>
													<div class="form-group">
														<label for="tenloai" class="col-form-label">Giá:</label> <input
															type="text" class="form-control" id="gia" name="txtGia">
													</div>
													<div class="form-group">
												...
												<div class="modal-footer">
													...
													<button type="submit" name="butthemdtq"
					...
					<div class="col">
						<table class="table table-dark table-bordered">
							...
							<tbody style="font-weight: 600">
								<c:forEach var="u" items="${dsDtquan}">
									<tr>
										<td class="pl-1 pt-4">${u.getDiemThamQuanId()}</td>
										<td class="pl-1 pt-4">${u.getDiemThamQuanName()}</td>
											...
											<table class="table table-dark table-borderless">
												...
												<td class="pt-4">
													...
													<button type="submit" class="btn btn-info"
														...
														data-bs-target="#modalxem${u.getDiemThamQuanId()}">
														<i class="bi bi-eye"></i>
													</button>
													<div class="modal fade"
														id="modalxem${u.getDiemThamQuanId()}" tabindex="-1"
														aria-labelledby="exampleModalLabel" aria-hidden="true">
														<div
															class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
															<div class="modal-content">
																<div class="modal-header">
																	<h1 class="modal-title fs-5" id="exampleModalLabel"
																		style="color: black">Chi tiết điểm tham quan</h1>
																	<button type="button" class="btn-close"
																		data-bs-dismiss="modal" aria-label="Close"></button>
																</div>
																<div class="modal-body">
																	<div class="form-group">
																		<label for="Name" class="col-form-label"
																			style="color: black">Tên điểm tham quan:</label> <input
																			type="text" class="form-control"
																			value="${u.getDiemThamQuanName() }">
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		<label for="TinhTrang" class="col-form-label"
																			style="color: black">Tình Trạng:</label> <input
																			type="text" class="form-control"
																			value="${u.getTinhTrang()}">
																	</div>
																	<div class="form-group">
																		<label for="tenloai" class="col-form-label"
																			style="color: black">Giá:</label> <input type="text"
																			class="form-control" value="${u.getGia() }">
																	</div>
																	<div class="form-group">
												...
												<td class="pt-4">
													<!-- <form action="CRUDdiemthamquan" method="post">
													...
													<button type="submit" class="btn btn-success"
														data-bs-toggle="modal"
														data-bs-target="#modalsua${u.getDiemThamQuanId()}">
														<i class="bi bi-pencil-square"></i>
													</button>
													<form action="CRUDdiemthamquan" method="post">
														<div class="modal fade"
															id="modalsua${u.getDiemThamQuanId()}" tabindex="-1"
															aria-labelledby="exampleModalLabel" aria-hidden="true">
															<div
																class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
																<div class="modal-content">
																	<div class="modal-header">
																		<h1 class="modal-title fs-5" id="exampleModalLabel"
																			style="color: black">Chỉnh sửa điểm tham quan</h1>
																		<button type="button" class="btn-close"
																			data-bs-dismiss="modal" aria-label="Close"></button>
																	</div>
																	<div class="modal-body">
																		<div class="form-group">
																			<label for="Name" class="col-form-label"
																				style="color: black">Tên điểm tham quan:</label> <input
																				type="text" class="form-control"
																				value="${u.getDiemThamQuanName()}" id="Name" name="txtTenS">
																		</div>
																		<div class="form-group">
																			<label for="DiaChi" class="col-form-label"
																				style="color: black">Địa Chỉ:</label> <input
																				type="text" class="form-control"
																				value="${u.getDiaChi()}" id="DiaChi" name="txtDiaChiS">
																		</div>
																		<div class="form-group">
																			<label for="TinhTrang" class="col-form-label"
																				style="color: black">Tình Trạng:</label> <input
																				type="text" class="form-control"
																				value="${u.getTinhTrang()}" id="TinhTrang" name="txtTinhTrangS">
																		</div>
																		<div class="form-group">
																			<label for="tenloai" class="col-form-label"
																				style="color: black">Giá:</label> <input type="text"
																				class="form-control" value="${u.getGia() }" id="Gia" name="txtGiaS">
																		</div>
																		<div class="form-group">
																			<label for="HinhAnh" class="col-form-label"
																				style="color: black">Ảnh:</label> <img
																		...
																		<div class="form-group">
																			<label for="GioiThieu" class="col-form-label"
																				style="color: black">Giới thiệu:</label>
																			<textarea type="text" rows="4" class="form-control"
																				placeholder="${u.getGioiThieu()}" id="GioiThieu" name="txtGioiThieuS"></textarea>
																		</div>
																		<div class="form-group">
																			<label for="Tag" class="col-form-label"
																				style="color: black">Tag:</label> <input type="text"
																				class="form-control"
																				value="${u.getDiemThamQuanTag()}" id="Tag" name="txtTagS">
																		</div>
																	</div>
																	<div class="modal-footer">
																		<button type="button" class="btn btn-secondary"
																			data-bs-dismiss="modal">Close</button>
																		<button type="submit" name="butsuadtq" value="${u.getDiemThamQuanId()}"
												...
												<td class="pt-4">
													<form action="CRUDdiemthamquan" method="post">
														<button type="submit" class="btn btn-danger"
															name="butxoadtb" value="${u.getDiemThamQuanId() }">

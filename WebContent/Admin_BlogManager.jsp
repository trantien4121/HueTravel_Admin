				...
				<div class="row g-2">
					<div class="col">
						<table class="table table-dark table-bordered">
							<thead">
								<tr>
									<th class="pl-1">BlogId</th>
									<th class="pl-1">UserId</th>
									<th class="pl-1">Hình Ảnh</th>
									<th class="pl-1">Tiêu Đề</th>
									<th class="pl-1">Lượt Like</th>
									<th class="d-flex justify-content-center">&nbsp;</th>
								</tr>
							</thead>
							<tbody style="font-weight: 600">
								<c:forEach var="u" items="${dsBlogs}">
									<tr>
										<td class="pl-1 pt-4">${u.getBlogId()}</td>
										<td class="pl-1 pt-4">${u.getUserId()}</td>
										<td><img src="${u.getHinhAnh() }"
											width="80px" height="80px" class="pl-2 pt-2 pb-2" /></td>
										<td class="pl-1 pt-4">${u.getTieuDe()}</td>
										<td class="pl-1 pt-4">${u.getLuotLike()}</td>
										<td>
											<table class="table table-dark table-borderless">
												...
												<td class="pt-4">
													<form action="CRUDblog" method="post">
														<button type="submit" class="btn btn-danger" name="butxoablog"
														value="${u.getBlogId()}">
